...
namespace RedSocial09.ViewModel
{
    ...
    public class LoginViewModel : GeneralViewModel
    {
        ...
        public string TituloIniciar
        {
            get { return "Iniciar sesión"; }
        }

        public string TituloRegistro
        {
            get { return "Nuevo Usuario"; }
        }

        public string TituloLogin
        {
            get { return "Nombre de usuario"; }
        }

        public string TituloPassword
        {
        ...
        private async void IniciarSesion()
        {
            try
            {
                ...
                if (us != null)
                {
                    ...
                    await _navigator.PushAsync<PrincipalViewModel>(viewModel => { Titulo = "Pantalla Principal"; });
                }
                else
                {
        ...
        {
            await _navigator.PopToRootAsync();
            await _navigator.PushModalAsync<RegistroViewModel>(viewModel => { Titulo = "Registro de Nuevo Usuario"; });
        }
    }
}
